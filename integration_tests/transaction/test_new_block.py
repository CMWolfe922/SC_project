...
from src.common.initialize_blockchain import initialize_blockchain
from src.common.io_blockchain import get_blockchain_from_memory
from src.common.io_mem_pool import store_transactions_in_memory
...
def create_good_transactions(camille):
    ...
    transactions_str = [
        transaction.transaction_data for transaction in transactions]
...
def create_bad_transactions(camille):
    utxo_0 = TransactionInput(transaction_hash="5669d7971b76850a4d725c75fbbc20ea97bd1382e2cfae43c41e121ca399b660",
                              output_index=0)
    output_0 = TransactionOutput(
        public_key_hash=b"a037a093f0304f159fe1e49cfcfff769eaac7cda", amount=25)
    transaction_1 = Transaction(inputs=[utxo_0], outputs=[output_0])
    transaction_1.sign(camille)
    transactions = [transaction_1]
    transactions_str = [
