...
class NewBlock:
    ...
    def receive(self, new_block: dict):
        ...
        self.new_block = Block(
            transactions=new_block["transactions"], block_header=block_header)
        try:
            ...
            raise NewBlockException(
                "", "Previous block provided is not the most recent block")
    ...
    def _validate_hash(self):
        ...
        number_of_zeros_string = "".join(
            [str(0) for _ in range(NUMBER_OF_LEADING_ZEROS)])
        try:
